        ...
        <Container className={style.main_container}>
          ...
          >
            ...
            <div className={style.options_btn}>
              ...
              <div>
                <button
                  className={check === "points" ? style.cond : "me-3"}
                  onClick={toggleTextLenght}
                >
                  Text
                </button>
                ...
                <select
                  ...
                  className={
                    showTextLength === false
                      ? `d-none ${style.Contact_select}`
                      : `d-inline-flex ${style.Contact_select}`
                  }
                  style={{ width: "6.5rem" }}
                  onChange={(e) => {
            ...
            {isSummary ? (
              ...
              >
                <div
                  className={`${style.summary_heading} d-flex mb-2 align-items-center justify-content-end`}
                >
                ...
                <div className={style.summary_inside}>
                  {ytData ? (
                    <p style={{ overflow: "auto" }} id="text">
                      {ytData === "" ? (
                        <h6 className="py-2 text-center">
                          {" "}
                          {err !== ""
                            ? err
                            : "Sorry, the data was not readable, please try link again."}
                        </h6>
                      ) : ytData !== "" ? (
                        <div>
                          <span>
